		...
		<div className="home-banner-e-wrapper md:flex bg-white  hidden">
			...
			<div className="hero-main flex justify-center mt-10 w-1/3">
				<div className="main-info w-full" >
					...
					<div className="cny-sol font-bold text-center text-base mb-1" >Self-Storage and Door-to-Door Storage in Hong Kong</div>
					...
					<div className="hero-btn-wrap flex justify-between items-center mt-3">

						<a className="btn-locker flex bg-center bg-no-repeat shadow-lg"
						>SELF-STORAGE</a>
			...
			<div className="valet-bg bg-cover w-1/3"></div>
		</div>
	)
}
